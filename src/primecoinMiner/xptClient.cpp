...
xptClient_t* xptClient_connect(jsonRequestTarget_t* target, uint32 payloadNum, double donationAmount)
{
   ...
   if (donationAmount > 0)
   {
      xptClient_addDeveloperFeeEntry(xptClient, developerWallet, getFeeFromDouble(donationAmount)); // Dev Donation
   }
#ifdef _WIN32
